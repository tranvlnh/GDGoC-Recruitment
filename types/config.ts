...
export const essayQuestionSchema = baseQuestionSchema.extend({
  ...
  (question) => !question.minLength || !question.maxLength || question.minLength <= question.maxLength,
...
export const settingsSchema = z.object({
  ...
  (settings) => new Date(settings.applicationOpenAt) < new Date(settings.applicationCloseAt), {
