...
export function GdgocLogo({ className = "h-8 w-auto" }: { className?: string }) {
    return (
...
export function GoogleDots({ className = "" }: { className?: string }) {
    return (
        <div className={`inline-flex items-center gap-1.5 ${className}`}>
            ...
            <span className="w-2.5 h-2.5 rounded-full bg-[#EA4335] animate-pulse" style={{ animationDelay: "150ms" }}></span>
            <span className="w-2.5 h-2.5 rounded-full bg-[#FBBC05] animate-pulse" style={{ animationDelay: "300ms" }}></span>
            <span className="w-2.5 h-2.5 rounded-full bg-[#34A853] animate-pulse" style={{ animationDelay: "450ms" }}></span>
        </div>
    );
}
...
export function PaletteIcon({ className = "w-5 h-5" }: { className?: string }) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4 5 5 0 014-5h10a4 4 0 014 4v1a4 4 0 01-4 4H7z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a9 9 0 00-9 9v1a4 4 0 004 4h10a4 4 0 004-4v-1a9 9 0 00-9-9z" />
        </svg>
    );
}
...
export function RocketIcon({ className = "w-5 h-5" }: { className?: string }) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 7.5a1.5 1.5 0 01-2.12-2.12l1.414-1.414a1.5 1.5 0 012.12 2.12l-1.414 1.414z" />
        </svg>
    );
}
